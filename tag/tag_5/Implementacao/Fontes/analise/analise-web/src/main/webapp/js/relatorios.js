			...
			path: 'relatorio/usuario',
				...
				var cols = [{ title: msgs['relatorios.col.tipo'], data: 'tipoRelatorio.nome'},
							  { title: '', data: 'idFavorito', width: '1%', sortable: false, render: function(data, display, row, meta) {
					        	  if (data == null) {
					        		  return '<a href="#" title="Favoritos"><i class="glyphicon glyphicon-star-empty"></i></a>';
					        	  } else {
					        		  return '<a href="#" title="Favoritos" data-fav="'+data+'"><i class="glyphicon glyphicon-star"></i></a>';
					        	  }
					          }},
			    ...
			    var otherFn = function() {
			    	  var $removerSelecionados = $('<button class="btn btn-sm" title="'+msgs['relatorios.btn.del']+'"><i class="glyphicon glyphicon-trash"></i></button>');
			    	  var $selecionarTodos = $('<button class="btn btn-sm" title="'+msgs['relatorios.btn.sel']+'"><i class="glyphicon glyphicon-check"></i></button>');
			...
			path: 'relatorio/favoritos',
				...
				var cols = [{ title: msgs['relatorios.col.tipo'], data: 'relatorio.tipoRelatorio.nome'},
					          { title: '', data: null, width: '1%', sortable: false, render: function() {
					        	  return '<a href="#" title="Favoritos"><i class="glyphicon glyphicon-star"></i></a>';
					          }},
